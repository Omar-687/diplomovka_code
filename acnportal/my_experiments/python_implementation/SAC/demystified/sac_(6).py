...
Original file is located at
    https://colab.research.google.com/drive/1TrqPm19eJx9SOKaVEv1bnwR1lf1snotb
...
import math
import random
from envs_gym.envs.EV_env import EVEnv
import gym
import numpy as np
...
# env1 = NormalizedActions(gym.make("EV-v0"))
# env1 = EVEnv()
# env = NormalizedActions(gym.make("Pendulum-v1"))
env = NormalizedActions(EVEnv())
...
while frame_idx < max_frames:
    ...
    for step in range(max_steps):
        if frame_idx >1000:
            ...
            next_state, reward, done,a1,b1 = env.step(action.numpy())
        else:
            action = env.action_space.sample()
            next_state, reward, done,a1,b1 = env.step(action)
